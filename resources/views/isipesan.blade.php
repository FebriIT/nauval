            ...
            <div class="card direct-chat direct-chat-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a name="" id="" class="btn btn-primary btn-sm" href="{{ url('guru/pesan') }}"
                            role="button">Back</a>
                    </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <div class="direct-chat-messages" style="height: 400px">
                        @foreach ($isipesan as $item)
                            @if ($item->user_type == 'App\Siswa')

                                <div class="direct-chat-msg">
                                    <div class="direct-chat-infos clearfix">
                                        <span class="direct-chat-name float-left">{{ $item->user->nama_siswa }}</span>
                                    </div>
                                    <!-- /.direct-chat-infos -->
                            ...
                            @else
                                ...
                                <div class="direct-chat-msg right">
                                    <div class="direct-chat-infos clearfix">
                                        <span class="direct-chat-name float-right">{{ $item->user->nama_guru }}</span>
                                    </div>
                                    <!-- /.direct-chat-infos -->
                                    <img class="direct-chat-img" src="{{ $item->user->getProfil() }}"
                                        alt="message user image">
                ...
                <div class="card-footer">
                    <form action="{{ url('guru/pesan/' . $id . '/kirim') }}" method="post">
                        @csrf
