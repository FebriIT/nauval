        ...
        <div class="main-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header"><b>TAMBAH KUIS</b></div>
                            <br>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input"
                                            data-target="#datetimepicker1" name="waktu_mulai"
                                            value="{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $obj->waktu_mulai)->format('d/m/Y H:i') }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datetimepicker2" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input"
                                            data-target="#datetimepicker2" name="waktu_selesai"
                                            value="{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $obj->waktu_selesai)->format('d/m/Y H:i') }}" />
