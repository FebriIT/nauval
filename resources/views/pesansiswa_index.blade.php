                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a name="" id="" class="btn btn-primary btn-sm" href="{{ url('siswa/pesan/user') }}"
                        ...
                        @foreach ($pesan as $item)
                            <div class="card">
                                <div class="card-body p-3">
                                    <a href="{{ url('siswa/pesan/' . $item->id . '/hapus') }}"
                                        class="badge badge-danger badge-pill float-right">Hapus</a>
                                    <a href="{{ url('siswa/pesan/' . $item->id) }}" class="media">
                                        <img src="{{ $item->guru->getProfil() }}" class="mr-3 rounded-circle" alt="..."
                                            width="70px">
                                        <div class="media-body">
                                            <div class="m-0">{{ $item->guru->nama_guru }}</div>
