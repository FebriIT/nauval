                                    ...
                                    <div class="card-body box-profile">
                                        <div class="text-center">
                                            <img class="profile-user-img img-fluid img-circle"
                                                src="{{ auth()->user()->getProfil() }}" alt="User profile picture">
                                        </div>
                                        <hr> <br>
                                                ...
                                                <div class="post">
                                                    <div class="user-block">
                                                        <img class="img-circle img-bordered-sm"
                                                            src="{{ auth()->user()->getProfil() }}" alt="user image">
                                                    ...
                                                    <!-- /.user-block -->
                                                    <p style="color: black"> tidak ada data
                                                    </p><br><br><br><br>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="profile-left">
                            ...
                            <div class="profile-header">
                                ...
                                <div class="profile-main">
                                    <img width="100" height="100" src="{{ auth()->user()->getProfil() }}" class="img-circle"
                                        alt="Avatar">
